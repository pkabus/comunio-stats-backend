...
public class ObjectMapperTest {
	...
	private final static FlatPlayerSnapshotDto EXPECTED_OBJECT_0 = new FlatPlayerSnapshotDto("Neuer",
			"/csprofile/30755-Neuer", 30755L, "Keeper", 30, "FC Bayern München", 2170000L, LocalDate.of(2021, 1, 8));
	private final static FlatPlayerSnapshotDto EXPECTED_OBJECT_1 = new FlatPlayerSnapshotDto("R. Hoffmann",
			"/csprofile/32855-R.+Hoffmann", 32855L, "Keeper", 0, "FC Bayern München", 160000L,
			LocalDate.of(2021, 1, 8));

	private final static String TEST_JSON_BRACKETS_EVERYWHERE = "[\n"
			+ "{\"name\": [\"Neuer\"], \"link\": [\"/csprofile/30755-Neuer\"], \"id\": \"30755\", \"position\": [\"Keeper\"], \"points_during_current_season\": [\"30\"], \"club\": [\"FC Bayern München\"], \"market_value\": [\"2170000\"], \"created\": \"2021-01-08 15:52:22\"}]";

	private final static String TEST_JSON_BRACKETS_AT_STRING_VALUES = "{\"name\": [\"Neuer\"], \"link\": [\"/csprofile/30755-Neuer\"], \"id\": \"30755\", \"position\": [\"Keeper\"], \"points_during_current_season\": [\"30\"], \"club\": [\"FC Bayern München\"], \"market_value\": [\"2170000\"], \"created\": \"2021-01-08 15:52:22\"}";

	private final static String TEST_JSON_NO_BRACKETS = "{\"name\": \"Neuer\", \"link\": \"/csprofile/30755-Neuer\", \"id\": \"30755\", \"position\": \"Keeper\", \"points_during_current_season\": \"30\", \"club\": \"FC Bayern München\", \"market_value\": \"2170000\", \"created\": \"2021-01-08 15:52:22\"}";

	private final static String TEST_JSON_BRACKETS_EVERYWHERE_TWO_ENTRIES = "[\n"
			+ "{\"name\": [\"Neuer\"], \"link\": [\"/csprofile/30755-Neuer\"], \"id\": \"30755\", \"position\": [\"Keeper\"], \"points_during_current_season\": [\"30\"], \"club\": [\"FC Bayern München\"], \"market_value\": [\"2170000\"], \"created\": \"2021-01-08 15:52:22\"},\n"
			+ "{\"name\": [\"R. Hoffmann\"], \"link\": [\"/csprofile/32855-R.+Hoffmann\"], \"id\": \"32855\", \"position\": [\"Keeper\"], \"points_during_current_season\": [\"0\"], \"club\": [\"FC Bayern München\"], \"market_value\": [\"160000\"], \"created\": \"2021-01-08 15:52:22\"}\n"
			+ "]";
